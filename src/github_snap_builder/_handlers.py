...
from . import _snap_builder, _status_reporter
...
def handle_pull_request(payload):
    ...
    status_reporter = _status_reporter.StatusReporter(repo, commit_sha, "http://example.com")
...
def _authenticated_github_app(payload):
    ...
    with open('/home/kyrofa/Downloads/snap-builder.2020-06-13.private-key.pem', 'rb') as f:
        key = f.read()
